        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title float-left">@lang("site.editProduct")</h3>
            </div>
            ...
            <form role="form" method="post" action = "{{route('dashboard.products.update',$product->id)}}" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input name="{{$local}}[title]" type="text" class="form-control" id="nameInput{{$local}}" value = "{{$product->translate($local)->title}}">
                </div>
                <!-- end name scope-->
                ...
                <div class="form-group">
                  ...
                  <textarea name="{{$local}}[description]" type="text" class="form-control ckeditor" id="descriptionInput{{$local}}">{!!$product->translate($local)->description!!}</textarea>
                </div>
                ...
                <!-- start image scope-->
                <div class="form-group">
                  <img id="image-preivew" src="{{$product->image_path}}" class="rounded-circle" width="150px" height="150px" style="border:2px solid#777">
                </div>
                <!-- end image scope-->
                ...
                <div class="form-group">
                  ...
                  <input name="purchase_price" type="number"  step = "0.01"   class="form-control " id="purchase_price" value="{{$product->purchase_price}}"  >
                ...
                <div class="form-group">
                  ...
                  <input name="sale_price" type="number"  step = "0.01"  class="form-control" value="{{$product->sale_price}}" id="sale_price"  >
