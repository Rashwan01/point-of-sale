        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title float-left">@lang("site.editUser")</h3>
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action = "{{route('dashboard.user.update',$user->id)}}" enctype="multipart/form-data">
              @csrf
              @method('put')
              <div class="card-body">
                <div class="form-group">
                  <label for="FirstNameInput">@lang("site.first_name")</label>
                  <input name="first_name" type="text" class="form-control" id="FirstNameInput" value = " {{$user->first_name}}">
                </div>
                <div class="form-group">
                  <label for="LastNameInput">@lang("site.last_name")</label>
                  <input name="last_name" type="text" class="form-control" id="LastNameInput" value =" {{$user->last_name}}" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <img id="image-preivew" src="{{$user->image_path}}" class="rounded-circle" width="150px" height="150px" style="border:2px solid#777">
                </div>
                <div class="form-group">
                     ...
                     <div class="tab-pane fade show  {{ $index == 0 ? 'active':''}} " id="{{$model}}" role="tabpanel" aria-labelledby="{{$model}}-tab">
                      <div class="form-group mt-5">
                        ...
                        <div class="custom-control custom-checkbox">
                          ...
                          type="checkbox"
                          name="permissions[]"
                          {{ ($user->hasPermission($map.'-'.$model))?'checked':''}}
                          value="{{$map.'-'.$model}}"
